...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--source-root",
        default=r"E:\毕设\code\visnir-det\data\iddaw_all_weather_full",
        help="Root directory of the paired all-weather dataset generated by visnir-det.",
    )
    parser.add_argument(
        "--output-root",
        default=r"E:\毕设\code\datasets\iddaw_all_weather_full_yolov11_rgbnir",
