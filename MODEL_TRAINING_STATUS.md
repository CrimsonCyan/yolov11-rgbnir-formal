...
| `bifpn_only_light_nir_p2p5_oa_resreflect_p2only_p3plain_c256_yolo11s_6cls_personmerge` | `configs/models/yolo11s_rgbnir_bifpn_p2p5_light_nir_oa_resreflect_p2only_p3plain_c256_6cls_personmerge.yaml` | `YOLO11s` 版 `true P2-P5 BiFPN + P2-only residual-reflect OA + P3 plain concat c256`：只在 P2 使用 residual-reflect soft-prior，P3/P4/P5 全部 plain concat |
| `oa_yolo_pan_light_nir_p2p5_c256_yolo11s_6cls_personmerge` | `configs/models/yolo11s_rgbnir_oa_yolo_pan_light_nir_p2p5_c256_6cls_personmerge.yaml` | `YOLO11s` 版 `OA + Light NIR branch + YOLO PAN-style P2-P5 head`：保留 P2 soft-prior 与 P3 OA-Reflect，移除 BiFPN，改用 YOLO 式 top-down/bottom-up PAN 检测头 |
...
| `rgb_yolo11s_6cls_personmerge` | `visible/train,val` | `BGR` | `3` | `20` | `10` | 已完成 `100 epoch`；YOLO11s RGB-only 统一基线 |
| `rgb_rtdetr` | `visible/train,val` | `BGR` | `3` | `32` | `10` | `50 epoch`，现补到 `70` 中 |
| `nir` | `nir/train,val` | `Gray` | `1` | `96` | `12` | `50 epoch` |
| `nir_yolo11s_6cls_personmerge` | `nir/train,val` | `Gray` | `1` | `20` | `10` | 已完成 `100 epoch`；YOLO11s NIR-only 统一基线 |
| `rgbnir` | paired `visible + nir` | `RGBNIR` | `4` | `48` | `10` | `50 epoch`，现补到 `70` |
| `rgbnir_yolo11s_6cls_personmerge` | paired `visible + nir` | `RGBNIR` | `4` | `20` | `10` | 已完成 `100 epoch`；YOLO11s RGB-NIR plain 统一基线 |
...
| `bifpn_only_light_nir_p2p5_c256_yolo11s_6cls_personmerge` | `iddaw-yolo11s-rgbnir-bifpn-only-light-nir-p2p5-c256-6cls-personmerge3` | `100 epoch, imgsz=800, Adam, lr0=0.01, batch=20, close_mosaic=15, device=0,1` | 已完成 | `0.74932` | `0.62619` | `0.67756` | `0.47606` | plain c256 复跑；低于上一轮 `0.47976` 约 `0.00370`，但仍显著高于 early fusion / OA+PAN，说明 BiFPN c256 的优势基本稳定但存在小幅随机波动 |
...
| `bifpn_only_light_nir_p2p5_oa_ms_softprior_resreflect_p2only_c256_yolo11s_6cls_personmerge` | `iddaw-yolo11s-rgbnir-bifpn-only-light-nir-p2p5-oa-ms-softprior-resreflect-p2only-c256-6cls-personmerge3` | `100 epoch, imgsz=800, Adam, lr0=0.01, batch=20, close_mosaic=15, device=0,1, P2 lambda=0.1` | 已完成 | `0.72459` | `0.62278` | `0.68380` | `0.48122` | P2 residual-reflect gate 略超 plain c256 的 `mAP50-95`，但低于 no-floor OA 的约 `0.482`，且 `person/motorcycle` 未超过 plain c256，不作为主结构晋级 |
| `bifpn_only_light_nir_p2p5_oa_resreflect_p2only_p3plain_c256_yolo11s_6cls_personmerge` | `iddaw-yolo11s-rgbnir-bifpn-only-light-nir-p2p5-oa-resreflect-p2only-p3plain-c256-6cls-personmerge2` | `100 epoch, imgsz=800, Adam, lr0=0.01, batch=20, close_mosaic=15, device=0,1, P2 lambda=0.1` | 已完成 | `0.76736` | `0.62219` | `0.68619` | `0.47808` | 去掉 P3 OA 后 precision 升高，但 `mAP50-95` 低于 residual-reflect P2-only，也未超过历史 plain c256，说明 P3 plain 不能解决 OA 小目标收益不足问题 |
| `oa_yolo_pan_light_nir_p2p5_c256_yolo11s_6cls_personmerge` | `iddaw-yolo11s-rgbnir-oa-yolo-pan-light-nir-p2p5-c256-6cls-personmerge` | `100 epoch, imgsz=800, Adam, lr0=0.01, batch=20, close_mosaic=15, device=0,1` | 已完成 | `0.69604` | `0.58125` | `0.64677` | `0.44644` | OA + YOLO PAN-style head 对照；明显低于 BiFPN c256，说明当前收益主要来自 BiFPN 多尺度结构而不是 OA 模块单独作用 |
| `early_fusion_yolo11s_6cls_personmerge` | `iddaw-yolo11s-rgbnir-early-fusion-6cls-personmerge` | `100 epoch, imgsz=800, Adam, lr0=0.01, batch=20, close_mosaic=15, device=0,1` | 已完成 | `0.75091` | `0.56376` | `0.63183` | `0.43720` | 单流 4 通道 early fusion 对照；计算量低但精度明显落后，支持双分支 Light NIR + 中后层多尺度融合路线 |
...
### 12.19 2026-04-28 OA-MS-SoftPrior 与 YOLO11s 统一基线完成结果

#### 12.19.1 `Multi-Scale OA Soft-Prior c256` 完成状态

- mode：`bifpn_only_light_nir_p2p5_oa_ms_softprior_c256_yolo11s_6cls_personmerge`
- run：`iddaw-yolo11s-rgbnir-bifpn-only-light-nir-p2p5-oa-ms-softprior-c256-6cls-personmerge2`
- 结果目录：`runs/IDD_AW/iddaw-yolo11s-rgbnir-bifpn-only-light-nir-p2p5-oa-ms-softprior-c256-6cls-personmerge2`
- 日志：`/data1/lvyanhu/code/yolov11-rgbnir-formal/remote_logs/iddaw/bifpn_only_light_nir_p2p5_oa_ms_softprior_c256_yolo11s_6cls_personmerge_e100_20260428_012425.stdout.log`
- W&B run：`7fsxrmhw`
- W&B 链接：`https://wandb.ai/hilbertschopenhauer-no/iddaw-rgbnir-formal/runs/7fsxrmhw`
- 运行配置：`100 epoch, imgsz=800, Adam, lr0=0.01, batch=20, close_mosaic=15, device=0,1`
- 训练状态：`100` epoch 正常完成，`best.pt` 与 `last.pt` 已导出
- `best.pt` 复验模型规模：`468 layers / 11,738,570 parameters / 132.90 GFLOPs`

主指标：

| 来源 | epoch | Precision | Recall | mAP50 | mAP50-95 |
| --- | ---: | ---: | ---: | ---: | ---: |
| `results.csv` best | 98 | 0.73526 | 0.61573 | 0.67506 | 0.47089 |
| `results.csv` last | 100 | 0.70924 | 0.61082 | 0.67020 | 0.47019 |
| `best.pt` 复验 | 98 | 0.735 | 0.616 | 0.675 | 0.471 |
...
| --- | ---: | ---: |
| `person` | 0.564 | 0.295 |
| `motorcycle` | 0.579 | 0.263 |
| `car` | 0.892 | 0.689 |
| `truck` | 0.592 | 0.463 |
| `bus` | 0.661 | 0.522 |
| `autorickshaw` | 0.761 | 0.593 |

与当前 plain c256 主基线（`mAP50 = 0.69135`, `mAP50-95 = 0.47976`）对比：

- 总体：`mAP50 -0.01629`，`mAP50-95 -0.00887`，未达到晋级标准。
- `person`：`0.561 / 0.296 -> 0.564 / 0.295`，几乎持平。
- `motorcycle`：`0.580 / 0.275 -> 0.579 / 0.263`，关键小目标高 IoU 明显下降。
- `car`：`0.888 / 0.686 -> 0.892 / 0.689`，略升。
- `truck`：`0.636 / 0.476 -> 0.592 / 0.463`，下降。
- `bus`：`0.669 / 0.538 -> 0.661 / 0.522`，下降。
- `autorickshaw`：`0.815 / 0.604 -> 0.761 / 0.593`，下降。

结论：

- 多尺度 smooth 与 soft-prior 让 `Object-Aware` 叙事更完整，但没有超过 plain c256。
- P2/P3 同时加 soft-prior 后，`person` 没有实质提升，`motorcycle` 反而下降，说明 P3 弱监督仍可能干扰小目标上下文。
- 当前 `Object-Aware` 仍不能作为主结构贡献，最多作为“目标先验探索/消融”保留。

#### 12.19.2 YOLO11s 统一基线补训完成状态

统一配方：`100 epoch, imgsz=800, Adam, lr0=0.01, batch=20, close_mosaic=15, device=0,1, IDDAW_CLASS_SCHEMA=6cls_personmerge`。

| 模式 | run | best epoch | mAP50 | mAP50-95 | W&B |
| --- | --- | ---: | ---: | ---: | --- |
| `rgb_yolo11s_6cls_personmerge` | `iddaw-yolo11s-rgb-6cls-personmerge10` | 100 | 0.62407 | 0.43800 | `zwtvq3er` |
| `nir_yolo11s_6cls_personmerge` | `iddaw-yolo11s-nir-6cls-personmerge2` | 100 | 0.57387 | 0.38912 | `qxz3uskm` |
| `rgbnir_yolo11s_6cls_personmerge` | `iddaw-yolo11s-rgbnir-plain-6cls-personmerge2` | 100 | 0.63355 | 0.43354 | `0qn901pr` |
| `rgbnir_light_nir_yolo11s_6cls_personmerge` | `iddaw-yolo11s-rgbnir-light-nir-6cls-personmerge3` | 99 | 0.64475 | 0.44745 | `9vubgdz2` |

类别 `mAP50-95` 对比：

| 模式 | person | motorcycle | car | truck | bus | autorickshaw |
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| RGB-only | 0.220 | 0.220 | 0.665 | 0.399 | 0.559 | 0.562 |
| NIR-only | 0.187 | 0.198 | 0.623 | 0.384 | 0.474 | 0.469 |
| RGB-NIR plain | 0.241 | 0.228 | 0.660 | 0.440 | 0.469 | 0.562 |
| RGB + Light NIR | 0.245 | 0.239 | 0.659 | 0.443 | 0.515 | 0.584 |

结果解读：

- NIR-only 明显弱于 RGB-only，说明 NIR 不能作为主语义分支替代 RGB。
- RGB-NIR plain 的 `mAP50` 高于 RGB-only，但 `mAP50-95` 略低，说明直接双流 concat 提升召回和低 IoU 命中，但定位质量不足。
- RGB + Light NIR 是四条统一 YOLO11s 基线中最好：相比 RGB-only，`mAP50 +0.02068`、`mAP50-95 +0.00945`。
- Light NIR 对 `person/motorcycle` 有小幅稳定增益，且对 `truck/autorickshaw` 的高 IoU 也更好；这支持“保留 RGB 主语义，NIR 作为轻量补充”的主线。
- 这四条基线都低于 `true P2-P5 BiFPN c256` 的 `mAP50-95 = 0.47976`，进一步确认主要结构增益来自 `BiFPN/P2-P5 多尺度融合`，不是单纯增加 NIR 输入。
...
第一优先级：补当前最强 plain c256 的 `close_mosaic=20` 对照，只改变一个训练策略变量。
...
- 验证 `close_mosaic=20` 是否能把当前最强 plain c256 从 `0.47976` 继续推高。
- 若提升，后续所有 OA 变体都必须以新的 close_mosaic=20 结果作为主基线。
- 若不提升，则固定 `close_mosaic=15`，停止在 mosaic 关闭时机上继续发散。
...
### 12.20 P2-only Multi-Scale OA Soft-Prior c256 启动记录
...
- 结构差异：
  ...
  - `P4/P5`: plain `Concat`
  - `BiFPNP2P5`: 仍为 `[256, 2]`
  - `Index` 和四尺度 refine head 仍保持 `256`
- 目的：验证上一轮 `P2/P3` soft-prior 同时约束导致 `motorcycle` 下降的问题是否主要来自 P3，同时适当增强 P2 目标先验强度。
...
#### 12.24.1 P2-only OA Residual-Reflect Gate 结果

- 结果目录：`runs/IDD_AW/iddaw-yolo11s-rgbnir-bifpn-only-light-nir-p2p5-oa-ms-softprior-resreflect-p2only-c256-6cls-personmerge3`
- 日志：`/data1/lvyanhu/code/yolov11-rgbnir-formal/remote_logs/iddaw/bifpn_only_light_nir_p2p5_oa_ms_softprior_resreflect_p2only_c256_yolo11s_6cls_personmerge_e100_20260429_224840.stdout.log`
- W&B run：`lyks2hqb`
- W&B 链接：`https://wandb.ai/hilbertschopenhauer-no/iddaw-rgbnir-formal/runs/lyks2hqb`
- 运行配置：`100 epoch, imgsz=800, Adam, lr0=0.01, batch=20, close_mosaic=15, device=0,1`
- 训练状态：`100` epoch 正常完成，`best.pt` 与 `last.pt` 已导出。
- 模型规模：
  - 训练构建 summary：`602 layers / 11,758,282 parameters / 85.92 GFLOPs`
  ...
  - W&B 记录：`134.255 GFLOPs`
- 辅助 loss 量级：
  - 首次 scale check：`aux_loss=0.104718`, `scaled_aux_loss=1.047184`, `det_loss=135.366653`, `batch_size=10`
  - `results.csv`: `train/fg_gate_loss 0.09053 -> 0.03396`
  - 说明 residual-reflect 的 foreground soft-prior loss 持续下降，且初始缩放后约为主检测 loss 的 `0.77%`，没有主导训练。

主指标：

| 来源 | epoch | Precision | Recall | mAP50 | mAP50-95 |
| --- | ---: | ---: | ---: | ---: | ---: |
| `results.csv` best | 96 | 0.72459 | 0.62278 | 0.68380 | 0.48122 |
| `results.csv` last | 100 | 0.74053 | 0.62300 | 0.67810 | 0.47697 |
| `best.pt` 复验 | 96 | 0.724 | 0.623 | 0.684 | 0.481 |

类别指标（`best.pt` 复验）：

| 类别 | Precision | Recall | mAP50 | mAP50-95 |
| --- | ---: | ---: | ---: | ---: |
| `person` | 0.786 | 0.478 | 0.565 | 0.295 |
| `motorcycle` | 0.795 | 0.497 | 0.588 | 0.271 |
| `car` | 0.798 | 0.837 | 0.882 | 0.677 |
| `truck` | 0.639 | 0.607 | 0.629 | 0.499 |
| `bus` | 0.638 | 0.632 | 0.676 | 0.548 |
| `autorickshaw` | 0.689 | 0.688 | 0.763 | 0.599 |

与当前关键对照的比较：

- 相比 `plain c256 BiFPN`（`mAP50 = 0.69135`, `mAP50-95 = 0.47976`）：`mAP50 -0.00755`，`mAP50-95 +0.00146`。总体高 IoU 略升，但低 IoU 检出质量下降。
- 相比 `P2-only OA-MS SoftPrior(lambda=0.1, no floor)`（约 `mAP50 = 0.685`, `mAP50-95 = 0.482`）：本轮 `mAP50-95 = 0.48122`，略低，未超过当前 OA 系列最好结果。
- `person`: plain c256 `0.561 / 0.296` -> residual-reflect `0.565 / 0.295`，`mAP50` 略升但 `mAP50-95` 基本持平略降。
- `motorcycle`: plain c256 `0.580 / 0.275` -> residual-reflect `0.588 / 0.271`，低 IoU 检出提升，但高 IoU 定位下降。
- `truck` 与 `bus` 的 `mAP50-95` 分别提升到 `0.499 / 0.548`，说明 residual-reflect 对部分中大目标或轮廓更明确目标有帮助。
- `car` 与 `autorickshaw` 下降，尤其 `autorickshaw mAP50` 从 plain c256 的约 `0.815` 降至 `0.763`，说明 OA residual 并非全类别稳定收益。

BiFPN 权重分析：

- 分析产物：`runs/analysis/bifpn_weights/resreflect_p2only_c256_best/`
- `P2_in / P3_td_up`: `0.5634 / 0.4365`
- `P3_in / P4_td_up`: `0.6727 / 0.3273`
- `P4_in / P5_up`: `0.8240 / 0.1748`
- `P3_out`: `P3_in 0.1519`, `P3_td 0.4135`, `P2_out_down 0.4346`
- `P4_out`: `P4_in 0.0532`, `P4_td 0.2175`, `P3_out_down 0.7292`
- `P5_out`: `P5_in 0.0000`, `P4_out_down 0.9974`

权重结论：

- 当前 best.pt 仍然主动压制 `P5_in`，并高度依赖 `P4_out_down` 生成 P5 输出。
- P2/P3/P4 路径占主导，和 floor 实验结论一致：当前数据不适合强制保留所有尺度边。
- residual-reflect 没有改变 BiFPN 的整体尺度选择逻辑，主要变化来自 P2 NIR residual 的局部修正。

OA gate 参数：

| 层 | 模块 | gate_scale | reflectance_scale | 其他 |
| --- | --- | ---: | ---: | --- |
| P2 | `ObjectAwareMultiScaleSoftPriorResidualReflectGateConcat` | -0.0199 | -0.5562 | `max_residual_scale=0.5`, `lambda=0.1` |
| P3 | `ObjectAwareMultiScaleReflectanceGateConcat` | 0.0333 | 0.1521 | 无辅助 loss |

P2 实际 residual scale 约为 `0.5 * sigmoid(-0.0199 - 0.5562) = 0.18`，说明该分支没有退化为完全关闭，也没有变成强行覆盖 NIR 主特征。它确实实现了“主特征直通 + 小幅 residual reflectance 修正”的设计目标。

结论：

- 本轮 residual-reflect 比 plain c256 的总 `mAP50-95` 略高，但收益只有 `+0.00146`，不足以作为强结论。
- 它没有超过 `P2-only OA-MS SoftPrior(lambda=0.1, no floor)`，未达到本轮第一晋级标准。
- `person/motorcycle mAP50-95 = 0.295 / 0.271`，没有超过 plain c256 的 `0.296 / 0.275`，未达到小目标晋级标准。
- residual-reflect 可作为“降低 OA gate 副作用”的消融保留，但当前不能替代 plain c256 作为主结构。

#### 12.24.2 下一步实验计划

下一步不再调 `floor`，也不建议继续增加 residual 幅度。当前更有价值的单变量实验是去掉 P3 的 OA-Reflect gate，只保留 P2 residual-reflect：

- 目的：验证 P3 `ObjectAwareMultiScaleReflectanceGateConcat` 是否仍在引入不必要的中层扰动。
- 结构：P2 使用 `ObjectAwareMultiScaleSoftPriorResidualReflectGateConcat(lambda=0.1)`，P3/P4/P5 全部回退为 plain concat，后续仍接普通 `BiFPNP2P5 c256` 和四尺度 Detect。
- 配方：`100 epoch, imgsz=800, Adam, lr0=0.01, batch=20, close_mosaic=15, device=0,1`。
- 判定标准：
  - 必须超过 residual-reflect 当前 `mAP50-95 = 0.48122`。
  - `person/motorcycle mAP50-95` 必须不低于 plain c256 的 `0.296 / 0.275`。
  - 若 P3 plain 后仍不能提升小目标，则停止 OA gate 结构训练，把论文主线固定为 `Light NIR branch + BiFPN`，OA 只作为对象先验消融和可视化分析内容。
...
```bash
WANDB_ENABLED=1 IMGSZ=800 OPTIMIZER=Adam LR0=0.01 BATCH=20 CLOSE_MOSAIC=15 IDDAW_CLASS_SCHEMA=6cls_personmerge \
bash scripts/iddaw/launch_nohup_train.sh bifpn_only_light_nir_p2p5_oa_resreflect_p2only_p3plain_c256_yolo11s_6cls_personmerge 100 0,1
```

若该实验失败，下一步应回到 `plain c256 + close_mosaic=20` 的单变量确认实验，而不是继续扩展对象先验模块。
...
#### 12.24.3 P3-plain OA / OA+PAN / Early Fusion / BiFPN-only 复跑结果

本轮队列已正常完成：

- 队列日志：`/data1/lvyanhu/code/yolov11-rgbnir-formal/remote_logs/iddaw/queue_oa_pan_early_fusion_bifpn_latest.log`
- 训练顺序：`P3-plain OA -> OA+YOLO PAN -> early fusion -> BiFPN-only c256 repeat`
- 统一配方：`100 epoch, imgsz=800, Adam, lr0=0.01, batch=20, close_mosaic=15, device=0,1`

运行信息：

| 实验 | 结果目录 | W&B run | 日志 |
| --- | --- | --- | --- |
| P2 residual-reflect + P3 plain + BiFPN c256 | `runs/IDD_AW/iddaw-yolo11s-rgbnir-bifpn-only-light-nir-p2p5-oa-resreflect-p2only-p3plain-c256-6cls-personmerge2` | [`bqwd227e`](https://wandb.ai/hilbertschopenhauer-no/iddaw-rgbnir-formal/runs/bqwd227e) | `remote_logs/iddaw/bifpn_only_light_nir_p2p5_oa_resreflect_p2only_p3plain_c256_yolo11s_6cls_personmerge_e100_20260430_015341.stdout.log` |
| OA + YOLO PAN-style head | `runs/IDD_AW/iddaw-yolo11s-rgbnir-oa-yolo-pan-light-nir-p2p5-c256-6cls-personmerge` | [`h77dsx3s`](https://wandb.ai/hilbertschopenhauer-no/iddaw-rgbnir-formal/runs/h77dsx3s) | `remote_logs/iddaw/oa_yolo_pan_light_nir_p2p5_c256_yolo11s_6cls_personmerge_e100_20260430_041313.stdout.log` |
| RGB+NIR early fusion | `runs/IDD_AW/iddaw-yolo11s-rgbnir-early-fusion-6cls-personmerge` | [`poyhiudk`](https://wandb.ai/hilbertschopenhauer-no/iddaw-rgbnir-formal/runs/poyhiudk) | `remote_logs/iddaw/early_fusion_yolo11s_6cls_personmerge_e100_20260430_062313.stdout.log` |
| BiFPN-only c256 repeat | `runs/IDD_AW/iddaw-yolo11s-rgbnir-bifpn-only-light-nir-p2p5-c256-6cls-personmerge3` | [`b709q7m4`](https://wandb.ai/hilbertschopenhauer-no/iddaw-rgbnir-formal/runs/b709q7m4) | `remote_logs/iddaw/bifpn_only_light_nir_p2p5_c256_yolo11s_6cls_personmerge_e100_20260430_070813.stdout.log` |

模型规模：

| 实验 | layers | parameters | GFLOPs | 说明 |
| --- | ---: | ---: | ---: | --- |
| P2 residual-reflect + P3 plain + BiFPN c256 | `569` | `10,451,655` | `70.32` | 只在 P2 保留 residual-reflect OA，P3/P4/P5 plain concat |
| OA + YOLO PAN-style head | `569` | `11,323,182` | `74.57` | 保留 OA 融合，但不用 BiFPN，改用 YOLO PAN-style 四尺度 head |
| RGB+NIR early fusion | `319` | `9,430,402` | `21.62` | 单流 4 通道输入，YOLO11s backbone + 原 YOLO PAN head |
| BiFPN-only c256 repeat | `536` | `10,121,924` | `54.57` | Light NIR + P2-P5 BiFPN c256，无 OA |

主指标：

| 实验 | best epoch | Precision | Recall | mAP50 | mAP50-95 | last mAP50-95 |
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| P2 residual-reflect + P3 plain + BiFPN c256 | `95` | `0.76736` | `0.62219` | `0.68619` | `0.47808` | `0.47209` |
| OA + YOLO PAN-style head | `100` | `0.69604` | `0.58125` | `0.64677` | `0.44644` | `0.44644` |
| RGB+NIR early fusion | `99` | `0.75091` | `0.56376` | `0.63183` | `0.43720` | `0.43591` |
| BiFPN-only c256 repeat | `100` | `0.74932` | `0.62619` | `0.67756` | `0.47606` | `0.47606` |

类别指标（`best.pt` 复验，表内为 `mAP50-95`）：

| 实验 | person | motorcycle | car | truck | bus | autorickshaw |
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| P2 residual-reflect + P3 plain + BiFPN c256 | `0.296` | `0.269` | `0.679` | `0.486` | `0.530` | `0.606` |
| OA + YOLO PAN-style head | `0.277` | `0.261` | `0.678` | `0.421` | `0.470` | `0.569` |
| RGB+NIR early fusion | `0.255` | `0.219` | `0.661` | `0.427` | `0.485` | `0.576` |
| BiFPN-only c256 repeat | `0.291` | `0.282` | `0.685` | `0.465` | `0.523` | `0.612` |

类别 precision / recall（`best.pt` 复验）：

| 实验 | person P/R | motorcycle P/R | car P/R | truck P/R | bus P/R | autorickshaw P/R |
| --- | --- | --- | --- | --- | --- | --- |
| P2 residual-reflect + P3 plain + BiFPN c256 | `0.842 / 0.440` | `0.879 / 0.439` | `0.841 / 0.827` | `0.697 / 0.644` | `0.692 / 0.627` | `0.735 / 0.723` |
| OA + YOLO PAN-style head | `0.803 / 0.428` | `0.826 / 0.431` | `0.831 / 0.812` | `0.555 / 0.489` | `0.553 / 0.567` | `0.721 / 0.688` |
| RGB+NIR early fusion | `0.817 / 0.390` | `0.797 / 0.378` | `0.844 / 0.803` | `0.580 / 0.613` | `0.674 / 0.524` | `0.797 / 0.679` |
| BiFPN-only c256 repeat | `0.797 / 0.470` | `0.835 / 0.479` | `0.825 / 0.832` | `0.652 / 0.644` | `0.588 / 0.597` | `0.803 / 0.729` |

对照分析：

- `BiFPN-only c256 repeat` 的 `mAP50-95 = 0.47606`，低于此前同配方 plain c256 的 `0.47976`，差值为 `-0.00370`。这说明上一轮 `0.47976` 不是完全不可复现的偶然峰值，但该结构存在约 `0.003-0.004` 的随机波动。
- `P2 residual-reflect + P3 plain` 的 `mAP50-95 = 0.47808`，比本次 BiFPN-only 复跑高 `+0.00202`，但仍低于历史 plain c256 `0.47976` 和 P2 residual-reflect + P3 reflect 的 `0.48122`。因此，去掉 P3 OA 没有解决 OA 小目标收益不稳定的问题。
- `P3 plain` 的 `person mAP50-95 = 0.296` 与历史 plain c256 基本持平，但 `motorcycle mAP50-95 = 0.269` 低于本次 BiFPN-only 复跑的 `0.282`。从小目标角度看，P3 plain 不晋级。
- `OA + YOLO PAN-style head` 的 `mAP50-95 = 0.44644`，明显低于 BiFPN-only c256 repeat 的 `0.47606`，且参数量和 GFLOPs 更高。这说明当前 OA 模块单独不能替代 BiFPN 的多尺度融合贡献。
- `early fusion` 的 `mAP50-95 = 0.43720`，显著低于 Light NIR + BiFPN 双分支路线。该结果支持论文中将 RGB 与 NIR 作为双分支特征进行中后层融合，而不是简单做输入级 4 通道拼接。
- 从类别看，BiFPN-only repeat 在 `motorcycle/car/autorickshaw` 上最高，P3-plain OA 主要提高了 precision，但没有转化为更高 recall 和定位精度。当前小目标瓶颈仍是 recall 与高 IoU 定位，而不是单纯 precision 不足。

阶段结论：

- 当前最稳主线仍是 `Light NIR branch + P2-P5 BiFPN c256`。
- OA 相关结构目前只能作为对象先验辅助消融和可视化叙事，尚不能作为强于 BiFPN-only 的主贡献写法。
- `P3 plain` 不晋级；继续围绕 P3 是否加 OA gate 进行微调的收益有限。
- `OA + YOLO PAN-style head` 和 `early fusion` 可保留为第四章消融对照：前者证明 BiFPN 是必要的，后者证明简单输入级融合不足。

下一步建议：

1. 论文主结构暂定为 `Light NIR branch + BiFPN`，OA-MS SoftPrior 作为对象先验增强模块和消融项叙述，不再把 OA gate 作为唯一主贡献。
2. 若继续补实验，优先做 `BiFPN-only c256, close_mosaic=20, Adam, lr0=0.01, imgsz=800, batch=20`，验证 close_mosaic 对当前最稳主线是否继续带来收益。
3. 若必须强化 OA 叙事，只做一个公平确认：`P2 residual-reflect OA + close_mosaic=20`，与上一条 plain BiFPN 使用完全相同配方；否则不再新增 OA 结构。
4. 第四章结果表可采用 `RGB-only / early fusion / RGB+Light NIR / OA+PAN / BiFPN-only / BiFPN+OA` 的消融顺序，但主结论应落在 BiFPN 多尺度融合和 Light NIR 分支，而不是 OA 单独提升。

### 12.25 OA 小目标增强实验启动计划

本阶段目标是验证 OA 是否可以通过“小目标定向监督”或“P2 检测头侧残差精修”改善 `person/motorcycle`。若两组实验仍不能超过 `BiFPN-only c256` 的小目标指标，则后续论文主线转为 `Light NIR branch + BiFPN`，OA 仅作为对象先验与可解释性消融。
...
- 统计 `mAP50-95 / AP50` 的 `all/small/medium/large` 分尺度结果。
- 单独输出 `person/motorcycle` 的分尺度指标与 `conf=0.25` 下 precision/recall。
- 对带 OA foreground loss 的模块统计 P2 object gate 的整体均值、框内均值、框外均值、`person/motorcycle` 框内均值。
- 对 residual-reflect 分支统计 residual correction 的整体、框内、框外平均响应。

新增实验 A：`Small-object weighted P2 OA`

- mode：`bifpn_only_light_nir_p2p5_oa_smallprior_p2only_p3plain_c256_yolo11s_6cls_personmerge`
- 配置：`configs/models/yolo11s_rgbnir_bifpn_p2p5_light_nir_oa_smallprior_p2only_p3plain_c256_6cls_personmerge.yaml`
- 基线来源：`P2 residual-reflect + P3 plain + BiFPN c256`
- 改动：只替换 P2 OA 为 `ObjectAwareMultiScaleSmallPriorResidualReflectGateConcat`
- 小目标权重公式：`box_weight = clamp((small_area_ref / area)^0.5, 1.0, 3.0)`
- 默认：`small_area_ref=0.0064`，约对应 `800x800` 输入下 `64x64` 目标；`foreground_loss_weight=0.1`，`max_residual_scale=0.5`

新增实验 B：`P2 head-side OA residual`

- mode：`bifpn_only_light_nir_p2p5_oa_headp2_smallprior_c256_yolo11s_6cls_personmerge`
- 配置：`configs/models/yolo11s_rgbnir_bifpn_p2p5_light_nir_oa_headp2_smallprior_c256_6cls_personmerge.yaml`
- 基线来源：plain `Light NIR + P2-P5 BiFPN c256`
- 改动：BiFPN 输入前保持 plain concat，不再调制 NIR；在 BiFPN P2 输出进入 P2 Detect refine 前添加 `ObjectAwareP2HeadResidualRefine`
- 模块输入：`[BiFPN_P2, RGB_P2, NIR_P2]`
- 输出：保持 `BiFPN_P2` 通道数不变，只做小幅 residual refine

统一训练配方：

```bash
WANDB_ENABLED=1 IMGSZ=800 OPTIMIZER=Adam LR0=0.01 BATCH=20 CLOSE_MOSAIC=15 IDDAW_CLASS_SCHEMA=6cls_personmerge \
bash scripts/iddaw/launch_nohup_train.sh <mode> 100 0,1
```
...
```bash
WANDB_ENABLED=0 IMGSZ=800 OPTIMIZER=Adam LR0=0.01 BATCH=20 CLOSE_MOSAIC=15 IDDAW_CLASS_SCHEMA=6cls_personmerge \
bash scripts/iddaw/launch_nohup_train.sh <mode> 1 0,1
```

晋级标准：

- 总 `mAP50-95` 必须超过 `0.48122`。
- `person mAP50-95 >= 0.296`。
- `motorcycle mAP50-95 >= 0.282`。
- 至少一个小目标类别相对本次 `BiFPN-only c256 repeat` 提升 `>= 0.005`。
...
### 12.27 OA 小目标诊断结果（IDD-AW 面积口径）

为避免 COCO 默认 `32^2/96^2` 面积划分在 IDD-AW `2048x1536` 原图上过于严格，本次将分尺度诊断口径调整为：

- `small`: `area <= 102^2`
- `medium`: `102^2 < area <= 306^2`
- `large`: `area > 306^2`

该口径对应 `2048x1536` 原图缩放到 `imgsz=640` 时的输入尺度小/中/大目标定义。修改位置：`formal_rgbnir/box_ops.py`。

诊断输出：

```text
/data1/lvyanhu/code/yolov11-rgbnir-formal/runs/analysis/oa_small_targets/core_compare_area102_306_20260501_193529
```

诊断命令仍使用 `--imgsz 800 --conf 0.001 --pr-conf 0.25 --iou 0.7 --device 0 --half --per-image`。本次只重新计算诊断指标，没有启动训练。

#### 12.27.1 分尺度总体结果

| 模型 | all mAP50-95 | small GT | small mAP50-95 | medium GT | medium mAP50-95 | large GT | large mAP50-95 | small P/R@0.25 |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| `bifpn_only` | `0.46775` | `2345` | `0.11070` | `1251` | `0.32892` | `435` | `0.20791` | `0.26356 / 0.53247` |
| `p2_resreflect` | `0.46873` | `2345` | `0.10522` | `1251` | `0.33057` | `435` | `0.18185` | `0.25654 / 0.50691` |
| `p3_plain` | `0.46763` | `2345` | `0.10902` | `1251` | `0.28784` | `435` | `0.27406` | `0.25469 / 0.52713` |
| `oa_yolo_pan` | `0.43502` | `2345` | `0.09720` | `1251` | `0.32142` | `435` | `0.17542` | `0.23743 / 0.48902` |

与旧 COCO 口径相比，small GT 从 `722` 增加到 `2345`，small 指标从接近零恢复到更符合道路场景的小目标评估范围。该变化说明旧口径统计的是极小目标，而新口径更接近 IDD-AW 原图与当前训练输入尺度下的小目标。

#### 12.27.2 person / motorcycle 小目标结果

| 模型 | person small GT | person small mAP50-95 | person small P/R@0.25 | motorcycle small GT | motorcycle small mAP50-95 | motorcycle small P/R@0.25 |
| --- | ---: | ---: | --- | ---: | ---: | --- |
| `bifpn_only` | `1271` | `0.12583` | `0.46545 / 0.43981` | `561` | `0.13043` | `0.46461 / 0.45633` |
| `p2_resreflect` | `1271` | `0.13140` | `0.46252 / 0.42722` | `561` | `0.12595` | `0.46585 / 0.47415` |
| `p3_plain` | `1271` | `0.12766` | `0.46037 / 0.40677` | `561` | `0.12152` | `0.45644 / 0.42959` |
| `oa_yolo_pan` | `1271` | `0.11672` | `0.43013 / 0.40205` | `561` | `0.11536` | `0.43694 / 0.43850` |

类别分析：

- `p2_resreflect` 对 `person small mAP50-95` 有提升，`0.12583 -> 0.13140`，但 `person small recall` 从 `0.43981` 降到 `0.42722`。这说明提升主要来自更高质量的部分检测框，而不是召回增加。
- `p2_resreflect` 对 `motorcycle small recall` 有提升，`0.45633 -> 0.47415`，但 `motorcycle small mAP50-95` 从 `0.13043` 降到 `0.12595`，说明新增召回没有转化为更好的高 IoU 定位。
- `p3_plain` 在 `person/motorcycle small recall` 上都弱于 `bifpn_only`，不支持继续把 P3 改成 plain 作为改进方向。
- `oa_yolo_pan` 在 small 指标上显著低于 BiFPN 系列，继续证明 BiFPN 的多尺度路径是必要的。

#### 12.27.3 Gate 与 residual 响应
...
Gate 结论与旧口径一致：OA gate 明显更关注目标框内区域，residual correction 也主要出现在 GT 框内。但检测指标说明，这种对象区域选择性尚未稳定转化为 small mAP 的全面提升。

#### 12.27.4 新口径下的阶段判断

- 面积口径修正后，small 指标不再异常接近零，因此后续论文和分析应使用 `102^2/306^2` 作为 IDD-AW 分尺度评估口径。
- 当前 `bifpn_only` 仍是 small 总体最稳结构：small `mAP50-95 = 0.11070`，small recall `0.53247`，均高于两个 BiFPN+OA 变体。
- `p2_resreflect` 只在 `person small mAP50-95` 和 `motorcycle small recall` 上有局部优势，不能证明 OA 对小目标有全面增益。
