...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--optimizer", default="", help="Optional optimizer override for train. Defaults to Adam.")
    ...
    parser.add_argument("--lr0", type=float, default=0.0, help="Optional initial learning rate override for train. Defaults to 0.01.")
