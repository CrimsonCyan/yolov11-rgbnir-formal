...
export BATCH="${BATCH:-20}"
export LR0="${LR0:-0.01}"
export COS_LR="${COS_LR:-0}"
export PRETRAINED="${PRETRAINED:-true}"
export CLOSE_MOSAIC="${CLOSE_MOSAIC:-0}"
export MOSAIC="${MOSAIC:-0}"
export SMALL_CENTER_GAIN="${SMALL_CENTER_GAIN:-0}"
export SMALL_SCALE_GAIN="${SMALL_SCALE_GAIN:-0}"
